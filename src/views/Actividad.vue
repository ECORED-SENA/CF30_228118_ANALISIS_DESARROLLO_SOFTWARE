  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Importancia de la gestión de la redundancia y alta disponibilidad 
        p.mb-4 Reconocer los motivos más representativos en la gestión de la redundancia y la alta disponibilidad. 
